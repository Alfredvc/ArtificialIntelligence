...
public class FunctionParserTest
{
    ...
    public void testSimpleMathematicalFunction() throws CannotCompileException, InstantiationException, NotFoundException, IllegalAccessException {
        ...
        Function constraint = FunctionParser.fromString("(double=Double:x,y,z,f)->(x + y + z + f)");
    ...
    public void testWithComplexClassesAsInput(){
        ...
        Function constraint = FunctionParser.fromString("(double=java.awt.Point:a,b)->Math.abs(a.x - b.x) + Math.abs(a.y - b.y)");
    ...
    public void testFunctionParsingWithSeveralInputTypes(){
        ...
        Function constraintFromString = FunctionParser.fromString("(double=Double:x,y,z,f|Boolean:a)->a ? x * y : z * f");
    ...
    public void testFunctionParsingWithListInput(){
        ...
        Function constraintFromString = FunctionParser.fromString("(double=java.util.List:l)->double tot = 1; for(java.util.Iterator iterator = ((java.util.List) l).iterator(); iterator.hasNext(); ){ Object o = iterator.next();tot*=((Double)o).doubleValue();} return tot;");
    ...
    public void performanceComparisonWithPrimitives(){
        Function constraintFromString = FunctionParser.fromString("(double=Double:x,y,z,f)->x*y + y + z*z + x*f");
        Object[] args = {Double.valueOf(1.0), Double.valueOf(2.0), Double.valueOf(3.0), Double.valueOf(4.0)};
    ...
    public void testParametrizedFunction(){
        ...
        Function<Point> pointFunction = FunctionParser.fromString("(java.awt.Point=java.awt.Point:a,b)->return new java.awt.Point(a.x + b.x,a.y + b.y);");
        assertThat(pointFunction.evaluate(args), is(expectedResult));
    }
